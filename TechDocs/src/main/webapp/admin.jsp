		...
		<div class="row mt-3">
			...
			<div class="col-md-4">
				<div class="card" style="background-color: #ffffff00;">
					...
					<div class="card-body  text-center">
						<div class="container">
							<img style="max-width: 140px" class="img-fluid rounded-circle"
								alt="user_icon" src="img/articles.jpg">
						</div>
						<h1><%=m.get("productCount") %></h1>
						<h1 class="text-uppercase text-muted">Articles</h1>
					</div>
		...
		<div class="col-md-6">
				<div class="card" style="background-color: #ffffff00;">
					...
					<div class="card-body  text-center">
						...
						<h1><%=m.get("categoryCountNormal") %></h1>
						<a  href="validCategory.jsp"> <h1 class="text-uppercase text-muted">Validate Category</h1></a>
			...
			<div class="col-md-6">
				<div class="card" style="background-color: #ffffff00;">
					...
					<div class="card-body  text-center">
						<div class="container">
							<img style="max-width: 195px" class="img-fluid rounded-circle"
								alt="user_icon" src="img/articles.jpg">
						</div>
						<h1><%=m.get("productCountNormal") %></h1>
						<a  href="validation.jsp"> <h1 class="text-uppercase text-muted">Validate Articles</h1></a>
